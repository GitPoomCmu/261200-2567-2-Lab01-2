 ...
 */
 ...
 public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
 {
     ...
     public static void main(String[] a)
     {
        ...
        // Bob draws the persimmon.
         bob.penColor("orange"); // Set color.
         bob.down();
         // Left circle
         for(int i=120; i>=0; i--){ 
             bob.forward(6);
         ...
         bob.setDirection(0); // Reset angle.

        // Bob draws persimmon's leafs and stem.
         bob.penColor("lime"); // Set color.
         bob.up();
         // Positioning
         bob.left(180); 
         bob.forward(120);
         ...
         bob.setDirection(0);
         bob.forward(65);
         bob.dot("darkgreen", 40);
         bob.left(90);
         bob.forward(9);
         bob.dot("green", 25);
         bob.setDirection(0); // Reset angle.

        // Bob draws an extra slice.
        bob.setPosition(50, -150);
        bob.down();
        bob.left(60);
        bob.penColor("orange"); // Set color.
        bob.forward(220);
        ...
        // Bob takes a rests. Thank you Bob!
        bob.up();
        bob.setDirection(90);
        bob.forward(100);
        while(true){
